<div class="px-5 pt-4"><div class="_1l1MA"><p>You are given a positive integer <code>n</code>. Each digit of <code>n</code> has a sign according to the following rules:</p>
